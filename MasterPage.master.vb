...
Partial Class MasterPage
    ...
    Sub mnu0105_click(ByVal sender As Object, ByVal e As EventArgs)
        If (String.IsNullOrEmpty(Request.QueryString("pNoTrans"))) Then
            PESAN("Anda Belum memilih Pasien")
        Else
            Response.Redirect("~/FrmJadwalOperasi.aspx?" + "pNoRM=" + Request.QueryString("pNoRM") + "&pNoReg=" + Request.QueryString("pNoReg") + "&pNoTrans=" + Request.QueryString("pNoTrans"))
        End If
    ...
    Private Sub PESAN(ByVal cpesan As String)
        Page.ClientScript.RegisterStartupScript(Me.GetType, "ClientSideScript", "<script type='text/javascript'>window.alert('" & cpesan & "')</script>")
    End Sub
End Class
