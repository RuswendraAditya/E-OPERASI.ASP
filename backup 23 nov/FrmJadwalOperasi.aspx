...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContent" runat="Server">
    ...
    <div>
        <asp:HiddenField ID="hdnboxOperasi" runat="server" />
        &nbsp; &nbsp; &nbsp;&nbsp;
        ...
        <div class="gridContainer">
            ...
            <asp:TextBox ID="txtTglDaftar" runat="server" Font-Size="Small" Width="79px"></asp:TextBox><br />
        ...
        <div class="gridContainer">
            ...
            <br />
            <asp:Label ID="Label16" runat="server" Text="Tgl Operasi" Font-Size="Small"></asp:Label>
            <asp:TextBox ID="txtTglOperasi" runat="server" Width="70px" Font-Size="Small"></asp:TextBox><br />
            <asp:Label ID="Label18" runat="server" Text="Jam Operasi" Font-Size="Small"></asp:Label>&nbsp;
    <asp:TextBox ID="txtJamOperasi" runat="server" Width="40px" Font-Size="Small"></asp:TextBox>
            ...
            <asp:Label ID="Label20" runat="server" Text="Ruang Operasi" Font-Size="Small"></asp:Label>
      ...
      <br />
        ...
        <div class="gridContainer">
            ...
            <asp:Label ID="Label2" runat="server" Text="Rencana Operasi" Font-Size="Small"></asp:Label>
            <asp:TextBox ID="txtPlanDay" runat="server" Width="90px" Font-Size="Small"></asp:TextBox>&nbsp;
            <br />


            <asp:Label ID="Label32" runat="server" Text="Perkiraan Lama Operasi" Font-Size="Small"></asp:Label>
            ...
            <br />
            <asp:Label ID="Label3" runat="server" Text="Pukul" Font-Size="Small"></asp:Label>
            ...
            <br />
            <asp:Label ID="Label4" runat="server" Text="Sifat Operasi" Font-Size="Small"></asp:Label>
            &nbsp;
    <asp:DropDownList ID="dropDownSifatOperasi" runat="server" Font-Size="Small">
        ...
        <asp:ListItem>Daftar Tunggu</asp:ListItem>
            ...
            <br />
            <asp:Label ID="Label5" runat="server" Text="Derajat Kontaminasi" Font-Size="Small"></asp:Label>
            &nbsp;
    <asp:DropDownList ID="DropDownDerajat" runat="server">
        ...
        <asp:ListItem>K</asp:ListItem>
            ...
            <br />
            <asp:Label ID="Label6" runat="server" Text="Lokasi Operasi" Font-Size="Small"></asp:Label>
            ...
            <br />
            <br />
            <asp:Label ID="Label7" runat="server" Text="Diagnosa Utama" Font-Size="Small"></asp:Label>
            <asp:TextBox ID="txtDiagnosaUtama" runat="server" TextMode="MultiLine" MaxLength="32767" Font-Size="Small"></asp:TextBox>
            <br />
            <asp:Label ID="Label8" runat="server" Text="Diagnosa Penyerta" Font-Size="Small"></asp:Label>
            <asp:TextBox ID="txtDiagnosaPenyerta" runat="server" TextMode="MultiLine" MaxLength="32767" Font-Size="Small"></asp:TextBox>
            <br />
            <div>
                <asp:Label ID="Label9" runat="server" Text="Operasi / Tindakan" Font-Size="Small"></asp:Label><br />
            ...
            <asp:Label ID="Label10" runat="server" Text="Keterangan Lain" Font-Size="Small"></asp:Label>
            <asp:TextBox ID="txtKetLain" runat="server" TextMode="MultiLine" MaxLength="32767" Font-Size="Small"></asp:TextBox>
            <br />
            <asp:Label ID="Label11" runat="server" Text="Alasan Pembatalan" Font-Size="Small"></asp:Label>
            <br />
            <asp:TextBox ID="txtKdBatal" runat="server" TextMode="MultiLine" Width="55px" MaxLength="8" Height="24px"></asp:TextBox>
            ...
            <br />
            <div>
                <asp:Label ID="Label12" runat="server" Text="Petugas yang daftar" Font-Size="Small"></asp:Label><br />
                <asp:TextBox ID="TxtNikPetugas" runat="server" TextMode="MultiLine" Width="46px" MaxLength="8" Height="24px" Font-Size="Small"></asp:TextBox>
